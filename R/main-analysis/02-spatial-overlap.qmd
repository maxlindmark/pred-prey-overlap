...
plot_map_fc + 
  ...
  scale_fill_viridis(trans = "sqrt", name = "Cod-Sprat overlap (ICES Rect.)",
                     ...
                     na.value = "yellow", limits = c(0, quantile(filter(cod_pel, year < 2020)$cod_spr_ovr, 0.999))) +
...
plot_map_fc + 
  ...
  scale_fill_viridis(trans = "sqrt", name = "Cod-Herring overlap (ICES Rect.)",
                         # trim extreme high values to make spatial variation more visible
                     na.value = "yellow", limits = c(0, quantile(filter(cod_pel, year < 2020)$cod_her_ovr, 0.999))) +
...
plot_map_fc + 
  ...
  facet_wrap(~year) + 
  scale_fill_viridis(name = "Cod-Herring overlap", trans = "sqrt")
...
plot_map_fc + 
  ...
  facet_wrap(~year) + 
  scale_fill_viridis(name = "Cod-Saduria overlap", trans = "sqrt")
