...
# vals <- exp(as.vector(as.matrix(sim_her[ , 1:500])))
# summary(vals)
# summary(vals[vals <= 1])
...
# vals <- exp(as.vector(as.matrix(sim_spr[ , 1:500])))
# summary(vals)
# summary(vals[vals <= 1])
...
# vals <- exp(as.vector(as.matrix(sim_sad[ , 1:500])))
# summary(vals)
# summary(vals[vals <= 1])
```
...
summary(pred_grid_density$sim_density)
summary(pred_grid_density2$sim_density)
```
